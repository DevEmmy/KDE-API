...
const documentation = require(settings.nodeEnv === 'development' ? './doc.config.json' : '../doc.config.json');
...
app.post('/api/v2/webhook', async (req: Request<{}, {}, WebhookPayload>, res, next) => {
  try {
