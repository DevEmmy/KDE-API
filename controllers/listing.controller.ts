...
class ListingController {
  ...
  public createListing = async (req: IRequest, res: Response, next: NextFunction) => {
  ...
  public deleteListing = async (req: IRequest, res: Response, next: NextFunction) => {
  ...
  public getAllListings = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public getSingleListing = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public getUserListing = async (req: IRequest, res: Response, next: NextFunction) => {
    try {
      const userId = <string>req.userId || req.params.id;
      const data = await this.listingService.getUserListings(userId);

      res.status(200).json({ message: 'User listings fetched successfully', data });
    } catch (error) {
      return next(error);
    }
  };

  public editListing = async (req: IRequest, res: Response, next: NextFunction) => {
  ...
  public saveListing = async (req: IRequest, res: Response, next: NextFunction) => {
    try {
      const listingId = req.params.id;
      const userId = <string>req.userId;
